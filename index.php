...
<div class="menu">
    <a href="biologie.php" class="carte">
        ...
        <h3>La Biologie</h3>
        <p>Pour explorer la Faune et la Flore du monde sous-marin</p>
        <span class="explorer">Explorer →</span>
    </a>
    
    <a href="epaves.php" class="carte">  
        <img src="images/barge_188.png" alt="">
        <h3>Les Épaves</h3>
        <p>Pour explorer les épaves sur lesquels les espèces ont été observées</p>
        <span class="explorer">Explorer →</span>
    </a>  
</div>
